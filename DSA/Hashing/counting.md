...
В Python модуль [collections](https://docs.python.org/3/library/collections.html) предоставляет очень полезные структуры данных. Мы будем использовать [defaultdict](https://docs.python.org/3/library/collections.html#collections.defaultdict) в коде на Python. С точки зрения функциональности, defaultdict — это то же самое, что и хеш-карта, просто с ним приятнее работать.
